...
<label htmlFor="content">Content</label>
 ...
 <div className="bg-white text-black rounded-lg overflow-hidden">
  <ReactQuill theme="snow" value={content} onChange={setContent}  modules={modules}  t
    placeholder="Enter your content here..." className="min-h-[300px] text-bl"
                        />
                    </div>
...
<button type="submit" disabled={saving || loadError}
 className="  px-5 py-2.5  rounded-xl  bg-indigo-600  hover:bg-indigo-500
  text-white font-medium transition disabled:opacity-50 disabled:cursor-not-allowed"
        >
        {saving ?"Saving...":id?"Update Note":"Create Note"}
          </button>
